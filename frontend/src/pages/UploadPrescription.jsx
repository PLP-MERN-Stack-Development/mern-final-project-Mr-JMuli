  ...
  return (
    <div className="max-w-2xl mx-auto mt-20 p-8 bg-white rounded shadow">
      ...
      <form onSubmit={handleSubmit}>
        <input type="file" multiple accept="image/*" className="w-full p-4 border mb-6" 
          onChange={e => setFiles(Array.from(e.target.files))} required />
        <button type="submit" className="w-full bg-blue-600 text-white py-4 rounded font-bold text-xl">
